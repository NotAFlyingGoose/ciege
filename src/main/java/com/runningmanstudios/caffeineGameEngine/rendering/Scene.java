...
import com.runningmanstudios.caffeineGameEngine.events.entity.EntityUpdateEvent;
...
public abstract class Scene implements Serializable {
	...
	private final Set<AbstractEntity> entities = Collections.newSetFromMap(new ConcurrentHashMap<>());;
	...
	/**
	 * calls the onCreate() method of all entities
	 */
	...
	/**
	 * calls the onExit() method of all entities
	 */
	...
	/**
	 * abstract onCreate() method, called when Scene Manager loads this scene
	 */
