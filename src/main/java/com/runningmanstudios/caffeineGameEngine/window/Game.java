...
public class Game implements Serializable {
	...
	public Game(int windowWidth, int windowHeight, String title) {
		try {
			...
			if (klass.isAnnotationPresent(GameBuilder.class)){
				this.builder = klass.getAnnotation(GameBuilder.class);
			} else {
	...
	private void printWelcomeMessage() {
		...
		String logo = 	"█▀▀ █ █▀▀ █▀▀ █▀▀\n"+
						"█▄▄ █ ██▄ █▄█ ██▄\n";
		GameLogger.console.requestPrintln("Caffeine Game Engine v" + this.VERSION, new Color(200, 255, 155), null);
		GameLogger.console.requestPrint(pot, HtmlStyle.getColor("silver"), null);
		GameLogger.console.requestPrint(logo, HtmlStyle.getColor("brown"), HtmlStyle.getColor("silver"));
		GameLogger.console.requestPrint("Thanks for using Ciege! visit our website at ", new Color(200, 255, 155), null);
		GameLogger.console.requestPrintln("https://www.runningmanstudios.com/ciege", new Color(155, 155, 255), null);
	}
