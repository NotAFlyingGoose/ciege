...
import com.runningmanstudios.caffeineGameEngine.events.entity.req.EntityCreateEvent;
...
public abstract class AbstractEntity implements IEntity, Serializable {
	...
	public void callCreate() {
    	if (!this.init) {
    		if (!this.sceneManager.getGame().getEventBus().emit(new EntityCreateEvent(this))) {
				this.init = true;
				this.onCreate();
			}
		}
