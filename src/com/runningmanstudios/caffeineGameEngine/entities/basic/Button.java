...
public abstract class Button extends AbstractEntity {
     ...
     */
    public Button(int x, int y, int width, int height, SceneManager sceneManager) {
    ...
    public void onMouseInputEvent(MouseInputEvent event) {
        ...
        if (new Rectangle((int) this.getX(), (int) this.getY(), (int) this.getWidth(), (int) this.getHeight()).contains(new Point(mouseX, mouseY))) {
            this.hover = true;
