...
public class Menu extends Scene {
    ...
    public void onCreate() {
        this.playbtn = new Button(this.getSceneManager().getGame().getWidth()/2, this.getSceneManager().getGame().getHeight()/2, 200, 50, this.getSceneManager()) {
        ...
        this.settingbtn = new Button(this.getSceneManager().getGame().getWidth()/2, this.getSceneManager().getGame().getHeight()/2, 200, 50, this.getSceneManager()) {
        ...
        this.aboutbtn = new Button(this.getSceneManager().getGame().getWidth()/2, this.getSceneManager().getGame().getHeight()/2, 200, 50, this.getSceneManager()) {
