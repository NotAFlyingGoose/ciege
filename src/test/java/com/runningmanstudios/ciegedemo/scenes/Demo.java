...
public class Demo extends Scene {
    ...
    public void onCreate() {
        this.backbtn = new Button(this.getSceneManager().getGame().getWidth()/2, 50, 200, 50, this.getSceneManager(), true) {
        ...
        this.grassworldbtn = new Button(this.getSceneManager().getGame().getWidth()/2, 50, 200, 50, this.getSceneManager(), true) {
        ...
        this.platformbtn = new Button(this.getSceneManager().getGame().getWidth()/2, 50, 200, 50, this.getSceneManager(), true) {
        ...
        this.otherbtn = new Button(this.getSceneManager().getGame().getWidth()/2, 50, 200, 50, this.getSceneManager(), true) {
